        ...
        <nav>
            <div className="mx-auto">
                <div className="flex items-start mx-auto justify-between">
                    <div className="flex sm: items-start justify-start my-0 md:justify-around w-full mx-auto md:ml-8 md:mr-16 lg:ml-4 lg:mr-8 xl:ml-8 xl:mr-4">
            ...
            {/* mobile navigation */}
            <div
                className={`fixed z-20 w-full  bg-white overflow-hidden flex flex-col lg:hidden gap-12  origin-top duration-700 ${!toggleMenu ? "h-0" : "h-full"}`}
            >
                <div className="px-8">
