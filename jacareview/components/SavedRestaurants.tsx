...
import jacaPhone from '../public/jaca-phone.png'
    ...
    return (
        ...
        {fetchedData && (
          savedData.map((element: any, index: number) => (
            <div className="flex flex-col items-center w-full shadow-xl w-11/12 mx-6 my-2 rounded bg-gradient-to-r from-green-200 from-10% via-green-100 via-30% to-green-100 to-90% text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl px-2 py-4" key={`a${index}`}>
